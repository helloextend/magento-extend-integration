...
use Extend\Integration\Test\Unit\Mock\CheckoutSessionMock;
   ...
   */
    ...
    protected function setUp(): void
    {
      // Create Stubs
        ...
        $this->checkoutSession = $this->getMockBuilder(CheckoutSessionMock::class)
        ->disableOriginalConstructor()
        ->onlyMethods(['getQuote', 'getData', 'hasData', 'setData', 'unsetData'])
        ->getMock();
