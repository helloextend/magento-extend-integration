...
class TotalsTest extends TestCase
{
   ...
   * @param float $price
   */
    protected function setupTest(float $price, $populateExtensionAttributes = true, $omitSp = null)
    {
      // Set mock return values
        ...
        $this->order->method('getData')->willReturnMap([
        ['shipping_protection', null, null],
        ['omit_sp', null, $omitSp],
        ]);
    ...
    {
        $price = 10.0;
        $this->setupTest($price, true, true);
