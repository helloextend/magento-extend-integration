...
class EnableProductProtection extends Value
{
    ...
    public function afterSave()
    {
        ...
        if ($isPPV2Enabled === 1) {
            ...
            // need to clean these cache types in order to immediately propagate the new settings to the storefront
            // and eliminate the need for the admin to flush the cache manually in order to see all the changes in the UI.
